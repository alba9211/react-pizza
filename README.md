...
Интернет-магазин пиццерии выполненный на всех нижеперечисленных технологиях.

## 🔥 Что было сделано:

- Разработано полноценное фронтенд-приложение на ReactJS.
- Созданы компоненты, страницы, сортировка, поиск, пагинация, фильтрация, popup-окна и т.д.
- Разработана навигация по странице без перезагрузки.
- Создано глобальное хранилище данных для всего приложения.
- Написан строго типизированный код на TypeScript.
